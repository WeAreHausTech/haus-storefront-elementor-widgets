...
class TestWidget extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        wp_enqueue_script(
            'haus-test-widget',
            HAUS_ECOM_PLUGIN_URI . 'vendor/haus-storefront-elementor-widgets/test-widget/dist/TestWidget.es.js',
            ['react'],
            null,
            true
        );
        ...
        <div id="<?= $widgetId ?>" class="ecom-components-root test-widget"
            data-widget-type="test-widget">
        </div>
        <?php
    }
}